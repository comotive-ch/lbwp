...
class WP_Object_Cache
{
  ...
  public function __construct()
  {
    ...
    // Add multiple servers, if given. Configuration below will
    // do failovers, if multiple instances are given and one breaks down
    $memcachedServers = array(
      array('127.0.0.1', 11211, 10)
    );

    // Declare prefix, key list and the persistent connection id
    $this->keyPrefix = DB_NAME . '_' . $table_prefix;
    $this->mc = new Memcached('persistent-connection-0001');
