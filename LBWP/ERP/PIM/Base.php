...
class Base extends ACFBase
{
  ...
  public function fields()
  {
    ...
    acf_add_local_field_group([
      'key' => 'group_pim_product_group_i18n',
      'title' => __('Übersetzungen', 'lbwp'),
      'fields' => [
        [
          'key' => 'field_pg_name_fr',
          'label' => __('Name (Französisch)', 'lbwp'),
          'name' => 'name-fr',
          'aria-label' => '',
          'type' => 'text',
          'instructions' => '',
        ...
        [
          'key' => 'field_pg_name_it',
          'label' => __('Name (Italienisch)', 'lbwp'),
          'name' => 'name-it',
          'aria-label' => '',
          'type' => 'text',
          'instructions' => '',
        ...
        [
          'key' => 'field_pg_name_en',
          'label' => __('Name (Englisch)', 'lbwp'),
          'name' => 'name-en',
          'aria-label' => '',
          'type' => 'text',
          'instructions' => '',
        ...
        [
          'key' => 'field_pg_desc_fr',
          'label' => __('Beschreibung (Französisch)', 'lbwp'),
          'name' => 'description-fr',
          'aria-label' => '',
          'type' => 'textarea',
          'instructions' => '',
        ...
        [
          'key' => 'field_pg_desc_it',
          'label' => __('Beschreibung (Italienisch)', 'lbwp'),
          'name' => 'description-it',
          'aria-label' => '',
          'type' => 'textarea',
          'instructions' => '',
        ...
        [
          'key' => 'field_pg_desc_en',
          'label' => __('Beschreibung (Englisch)', 'lbwp'),
          'name' => 'description-en',
          'aria-label' => '',
          'type' => 'textarea',
          'instructions' => '',
