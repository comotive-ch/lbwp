...
use LBWP\Module\General\PiwikIntegration;
use LBWP\Util\File;
...
class InformationBanner
{
  ...
  protected function __construct($options)
  {
    ...
    if (strlen($this->config['infoBannerButtonOptout']) == 0) {
      $this->config['infoBannerButtonOptout'] = __('Ablehnen', 'lbwp');
    }
  }
  ...
  public function printScripts()
  {
    ...
    $config = array(
      'isActive' => true,
      'optout' => $this->config['infoBannerOptout'],
      'showFrom' => $ts - 864000,
      'showUntil' => $ts + 864000,
    ...
    echo '
      ...
      <div class="lbwp-info-banner" style="display:none;">
        ...
        ' .  ($this->config['infoBannerOptout'] == 0 ? '' : '
        <a href="#" class="lbwp-close-info-banner optout">
          <span>' . $this->config['infoBannerButtonOptout'] . '</span>
        </a>') . '
      </div>
    ';
  }
