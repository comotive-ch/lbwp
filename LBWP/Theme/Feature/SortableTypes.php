...
class SortableTypes
{
  ...
  public function displaySortInterface()
  {
    ...
    $mode = isset($config['mode']) ? $config['mode'] : 'tiles';
    ...
    echo '
      <div class="wrap ">
        ...
        <div class="media-frame type-sort-frame mode-'  . $mode . ' wp-core-ui mode-grid">
      ...
      $html .= '
        <li class="attachment save-ready" data-order="' . $item->menu_order . '" data-id="' . $item->ID . '">
          ...
          <div class="attachment-title">
            <span>' . apply_filters('sortabletype_' . $item->post_type . '_item_title', $item->post_title, $item) . '</span>
          </div>
