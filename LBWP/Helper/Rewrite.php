...
class Rewrite
{
   ...
   */
  public static function rewriteMediaAssetsToExoscaleNativeUrl($html)
  {
    return Strings::replaceByXPath($html, '//source[@src] | //video[@src] | //audio[@src]', function ($doc, $tag, $fragment) {
      /**
      ...
      if (
        Strings::endsWith($parts['path'], '.mp3') ||
        Strings::endsWith($parts['path'], '.mp4') ||
        Strings::endsWith($parts['path'], '.webm'))
      {
