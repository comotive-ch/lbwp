...
class Core
{
  ...
  protected $path = '';
  /**
   * @var bool checks if the site has woocommerce installed
   */
  protected static $hasWooCommerce = false;
  /**
  ...
  public function __construct($path)
  {
    ...
    self::$hasWooCommerce = WordPress::isPluginActive('woocommerce/woocommerce.php');
  }
  ...
  public function initialize()
  {
    ...
    $this->loadFeatures();
    $this->loadConfig();
    // Load the text override module pomo
    $this->module['pomo'] = new Pomo();
