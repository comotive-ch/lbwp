...
class FormEditor extends Base
{
    ...
    echo '
      <script type="text/javascript">
        ...
        LbwpFormEditor.Text = {
          ...
          confirmDuplicate : "' . esc_js(__('Wollen sie dieses Feld duplizieren?', 'lbwp')) . '",
          confirmMultiDuplicate : "' . esc_js(__('Wollen sie diese Felder wirklich duplizieren?', 'lbwp')) . '",
          confirmMultiDelete : "' . esc_js(__('Wollen sie diese Felder wirklich löschen?', 'lbwp')) . '",
          ...
          itemConditionCondition : "' . esc_js(__('Kondition', 'lbwp')) . '",
          ...
          multiSelectFunctions : "' . esc_js(__('Funktionen:', 'lbwp')) . '",
          multiSelectFunctionDuplicateAll : "' . esc_js(__('Alle Felder duplizieren', 'lbwp')) . '",
          multiSelectFunctionDeleteAll : "' . esc_js(__('Alle Felder löschen', 'lbwp')) . '",
  ...
  protected function integrateTemplate($shortcode)
  {
    ...
    if (strlen(trim($shortcode)) == 0) {
      ...
      $shortcode = '
        [' . FormHandler::SHORTCODE_FORM . ' button="' . __('Absenden', 'lbwp') . '" meldung="' . $msg . '" redirect="0" hide_after_success="1" disable_enctype="0" use_spambotcheck="1"]
    ...
    $settings = '
      <div class="settings">
        ...
        <label class="checkbox-wrap">
          <input type="checkbox" name="hide_send_button" id="hide_send_button" value="1">' . __('Absende-Button ausblenden, bis alle Pflichtfelder ausgefüllt sind.', 'lbwp') . '
        </label>
        <label class="checkbox-wrap">
          <input type="checkbox" name="use_spambotcheck" id="use_spambotcheck" value="1">' . __('Verbesserten Schutz gegen Spam aktivieren.', 'lbwp') . '
        </label>
        <label class="checkbox-wrap">
          <input type="checkbox" name="show_survey_results" id="show_survey_results" value="1">' . __('Auswertung der Daten anzeigen (erfordert Datenspeicher).', 'lbwp') . '
        </label>
        <label class="checkbox-wrap">
        ...
        <label class="checkbox-wrap">
          <input type="checkbox" name="enable_multisite" id="enable_multisite" value="1">' . __('Mehrseitiges Formular aktivieren', 'lbwp') . '
        </label>
        <label class="checkbox-wrap">
          <input type="checkbox" name="use_progress_bar" id="use_progress_bar" value="1">' . __('Fortschrittbalken statt Schritten verwenden', 'lbwp') . '
        </label>
        <label for="first_step_name">' . __('Name des ersten Schritt', 'lbwp') . '</label>
        <input type="text" name="first_step_name" id="first_step_name" value="">
        <br><br>
        <label for="back_button_title">' . __('Zurück Button Titel', 'lbwp') . '</label>
        <input type="text" name="back_button_title" id="back_button_title" value="">
        <br><br>
        <label for="next_button_title">' . __('Weiter Button Titel', 'lbwp') . '</label>
        <input type="text" name="next_button_title" id="next_button_title" value="">
        <br><br>
      </div>
    ';
