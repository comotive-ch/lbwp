...
class Snippets extends \LBWP\Module\Base
{
  ...
  public function initialize()
  {
    ...
    add_shortcode('lbwp:snippet', array($this, 'displaySnippet'));
  ...
  /**
   * @param array $args displays a snippet
   */
  public function displaySnippet($args)
  {
    return apply_filters('the_content', get_post($args['id'])->post_content);
  }
