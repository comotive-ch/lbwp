 ...
 */
class BillingApiV2 extends Component
{
  /**
   * Init API endpoint
   */
  public function init()
  {
    ...
    // To be activated when the v2 goes prod
  ...
  public function registerApiEndpoint()
  {
    ...
    register_rest_route('aboon/v2/get', 'sales', array(
  ...
  public function getOrders(\WP_REST_Request $request)
  {
    ...
    foreach ($orders as $order) {
      ...
      if(Strings::contains($pMethod, 'postfinance')){
        $pMethod = 'postfinance';
      }
