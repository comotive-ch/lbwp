...
namespace BrevoScoped\PhpParser\Lexer;

use BrevoScoped\PhpParser\Error;
use BrevoScoped\PhpParser\ErrorHandler;
use BrevoScoped\PhpParser\Lexer;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use BrevoScoped\PhpParser\Lexer\TokenEmulator\TokenEmulator;
