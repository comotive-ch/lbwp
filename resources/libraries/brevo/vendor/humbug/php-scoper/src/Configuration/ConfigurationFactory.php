 ...
 */
namespace BrevoScoped\Humbug\PhpScoper\Configuration;

use Exception;
use BrevoScoped\Humbug\PhpScoper\Configuration\Throwable\InvalidConfiguration;
use BrevoScoped\Humbug\PhpScoper\Configuration\Throwable\InvalidConfigurationFile;
use BrevoScoped\Humbug\PhpScoper\Configuration\Throwable\InvalidConfigurationValue;
use BrevoScoped\Humbug\PhpScoper\Patcher\ComposerPatcher;
use BrevoScoped\Humbug\PhpScoper\Patcher\Patcher;
use BrevoScoped\Humbug\PhpScoper\Patcher\PatcherChain;
use BrevoScoped\Humbug\PhpScoper\Patcher\SymfonyParentTraitPatcher;
use BrevoScoped\Humbug\PhpScoper\Patcher\SymfonyPatcher;
use BrevoScoped\PhpParser\PhpVersion;
use SplFileInfo;
use BrevoScoped\Symfony\Component\Filesystem\Filesystem;
use BrevoScoped\Symfony\Component\Finder\Finder;
...
use function BrevoScoped\Humbug\PhpScoper\chain;
...
use function BrevoScoped\Safe\file_get_contents;
use function trim;
