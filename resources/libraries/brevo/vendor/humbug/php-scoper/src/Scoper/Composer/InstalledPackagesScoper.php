...
use function BrevoScoped\Safe\json_decode;
use function BrevoScoped\Safe\json_encode;
...
final readonly class InstalledPackagesScoper implements Scoper
{
    ...
    public function __construct(private Scoper $decoratedScoper, private \Humbug\PhpScoper\Scoper\Composer\AutoloadPrefixer $autoloadPrefixer)
    {
    }
    /**
