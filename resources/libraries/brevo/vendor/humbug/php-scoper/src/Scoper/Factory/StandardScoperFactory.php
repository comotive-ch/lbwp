...
use BrevoScoped\Humbug\PhpScoper\PhpParser\TraverserFactory;
use Humbug\PhpScoper\Scoper\Composer\AutoloadPrefixer;
use Humbug\PhpScoper\Scoper\Composer\InstalledPackagesScoper;
use Humbug\PhpScoper\Scoper\Composer\JsonFileScoper;
use BrevoScoped\Humbug\PhpScoper\Scoper\NullScoper;
use BrevoScoped\Humbug\PhpScoper\Scoper\PatchScoper;
use BrevoScoped\Humbug\PhpScoper\Scoper\PhpScoper;
use BrevoScoped\Humbug\PhpScoper\Scoper\Scoper;
use BrevoScoped\Humbug\PhpScoper\Scoper\SymfonyScoper;
