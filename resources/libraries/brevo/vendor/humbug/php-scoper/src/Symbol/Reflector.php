 ...
 */
namespace BrevoScoped\Humbug\PhpScoper\Symbol;

use BrevoScoped\JetBrains\PHPStormStub\PhpStormStubsMap;
...
final readonly class Reflector
{
    private const MISSING_CLASSES = [
        ...
        // PHP 8.4
        // TODO: to report
        'BrevoScoped\Pdo\DbLib',
        'BrevoScoped\Pdo\Firebird',
        'BrevoScoped\Pdo\Odbc',
        'BrevoScoped\Pdo\Pgsql',
    ];
