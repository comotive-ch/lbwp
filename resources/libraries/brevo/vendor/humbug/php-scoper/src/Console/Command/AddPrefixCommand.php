 ...
 */
namespace BrevoScoped\Humbug\PhpScoper\Console\Command;

use BrevoScoped\Fidry\Console\Application\Application;
use BrevoScoped\Fidry\Console\Command\Command;
use BrevoScoped\Fidry\Console\Command\CommandAware;
use BrevoScoped\Fidry\Console\Command\CommandAwareness;
use BrevoScoped\Fidry\Console\Command\Configuration as CommandConfiguration;
use BrevoScoped\Fidry\Console\ExitCode;
use BrevoScoped\Fidry\Console\IO;
use BrevoScoped\Humbug\PhpScoper\Configuration\Configuration;
use BrevoScoped\Humbug\PhpScoper\Configuration\ConfigurationFactory;
use BrevoScoped\Humbug\PhpScoper\Configuration\Throwable\InvalidConfigurationValue;
use BrevoScoped\Humbug\PhpScoper\Configuration\Throwable\UnknownConfigurationKey;
use BrevoScoped\Humbug\PhpScoper\Console\ConfigLoader;
use BrevoScoped\Humbug\PhpScoper\Console\ConsoleScoper;
use BrevoScoped\Humbug\PhpScoper\Console\InputOption\PhpVersionInputOption;
use BrevoScoped\Humbug\PhpScoper\Scoper\Factory\ScoperFactory;
...
use BrevoScoped\Symfony\Component\Filesystem\Filesystem;
use BrevoScoped\Symfony\Component\Filesystem\Path;
use function array_map;
use function is_dir;
use function is_writable;
use function BrevoScoped\Safe\getcwd;
