...
use BrevoScoped\Humbug\PhpScoper\PhpParser\NodeVisitor\Resolver\OriginalNameResolver;
use BrevoScoped\Humbug\PhpScoper\PhpParser\NodeVisitor\UseStmt\UseStmtCollection;
use BrevoScoped\Humbug\PhpScoper\PhpParser\UseStmtName;
use BrevoScoped\Humbug\PhpScoper\Symbol\EnrichedReflector;
use BrevoScoped\PhpParser\Node;
use BrevoScoped\PhpParser\Node\Attribute;
use BrevoScoped\PhpParser\Node\Expr\ArrowFunction;
use BrevoScoped\PhpParser\Node\Expr\ClassConstFetch;
use BrevoScoped\PhpParser\Node\Expr\Closure;
use BrevoScoped\PhpParser\Node\Expr\ConstFetch;
use BrevoScoped\PhpParser\Node\Expr\FuncCall;
use BrevoScoped\PhpParser\Node\Expr\Instanceof_;
use BrevoScoped\PhpParser\Node\Expr\New_;
use BrevoScoped\PhpParser\Node\Expr\StaticCall;
use BrevoScoped\PhpParser\Node\Expr\StaticPropertyFetch;
use BrevoScoped\PhpParser\Node\IntersectionType;
use BrevoScoped\PhpParser\Node\Name;
use BrevoScoped\PhpParser\Node\Name\FullyQualified;
use BrevoScoped\PhpParser\Node\NullableType;
use BrevoScoped\PhpParser\Node\Param;
use BrevoScoped\PhpParser\Node\Stmt\Catch_;
use BrevoScoped\PhpParser\Node\Stmt\Class_;
use BrevoScoped\PhpParser\Node\Stmt\ClassMethod;
use BrevoScoped\PhpParser\Node\Stmt\Function_;
use BrevoScoped\PhpParser\Node\Stmt\Interface_;
use BrevoScoped\PhpParser\Node\Stmt\Property;
use BrevoScoped\PhpParser\Node\Stmt\TraitUse;
use BrevoScoped\PhpParser\Node\Stmt\TraitUseAdaptation\Alias;
use BrevoScoped\PhpParser\Node\Stmt\TraitUseAdaptation\Precedence;
use BrevoScoped\PhpParser\Node\Stmt\Use_;
use BrevoScoped\PhpParser\Node\UnionType;
