 ...
 */
namespace BrevoScoped\Humbug\PhpScoper\PhpParser;

use BrevoScoped\Humbug\PhpScoper\PhpParser\NodeVisitor\ExcludedFunctionExistsEnricher;
use BrevoScoped\Humbug\PhpScoper\PhpParser\NodeVisitor\ExcludedFunctionExistsStringNodeStack;
...
use BrevoScoped\Humbug\PhpScoper\Scoper\PhpScoper;
use BrevoScoped\Humbug\PhpScoper\Symbol\EnrichedReflector;
use BrevoScoped\Humbug\PhpScoper\Symbol\SymbolsRegistry;
use BrevoScoped\PhpParser\NodeTraverser as PhpParserNodeTraverser;
use BrevoScoped\PhpParser\NodeTraverserInterface;
use BrevoScoped\PhpParser\NodeVisitor as PhpParserNodeVisitor;
