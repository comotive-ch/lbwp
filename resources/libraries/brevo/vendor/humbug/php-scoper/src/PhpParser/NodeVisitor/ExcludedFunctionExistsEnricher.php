...
use BrevoScoped\PhpParser\Node\Expr\BinaryOp\BooleanAnd;
use BrevoScoped\PhpParser\Node\Expr\BinaryOp\BooleanOr;
use BrevoScoped\PhpParser\Node\Expr\BinaryOp\Equal;
use BrevoScoped\PhpParser\Node\Expr\BinaryOp\Identical;
use BrevoScoped\PhpParser\Node\Expr\BooleanNot;
...
use BrevoScoped\PhpParser\Node\Stmt\If_;
