...
use BrevoScoped\Humbug\PhpScoper\PhpParser\Node\NameFactory;
use BrevoScoped\PhpParser\Node;
use BrevoScoped\PhpParser\Node\Stmt;
use BrevoScoped\PhpParser\Node\Stmt\Declare_;
use BrevoScoped\PhpParser\Node\Stmt\GroupUse;
use BrevoScoped\PhpParser\Node\Stmt\InlineHTML;
...
use BrevoScoped\PhpParser\NodeVisitor;
