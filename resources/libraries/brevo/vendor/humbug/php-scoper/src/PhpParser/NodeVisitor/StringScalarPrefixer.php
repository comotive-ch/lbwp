...
use BrevoScoped\PhpParser\Node\ArrayItem;
use BrevoScoped\PhpParser\Node\Const_;
use BrevoScoped\PhpParser\Node\Expr\Array_;
use BrevoScoped\PhpParser\Node\Expr\Assign;
...
use BrevoScoped\PhpParser\Node\Stmt\PropertyProperty;
use BrevoScoped\PhpParser\Node\Stmt\Return_;
