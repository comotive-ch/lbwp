 ...
 */
namespace BrevoScoped\Symfony\Component\String;

use BrevoScoped\Symfony\Component\String\Exception\ExceptionInterface;
use BrevoScoped\Symfony\Component\String\Exception\InvalidArgumentException;
use BrevoScoped\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractString implements \Stringable, \JsonSerializable
{
    ...
    public function toByteString(?string $toEncoding = null): ByteString
    {
        ...
        try {
            ...
            if (!\function_exists('iconv') && !\function_exists('BrevoScoped\iconv')) {
