 ...
 */
use BrevoScoped\Symfony\Polyfill\Intl\Normalizer as p;
if (!\function_exists('normalizer_is_normalized') && !\function_exists('BrevoScoped\normalizer_is_normalized')) {
...
if (!\function_exists('normalizer_normalize') && !\function_exists('BrevoScoped\normalizer_normalize')) {
