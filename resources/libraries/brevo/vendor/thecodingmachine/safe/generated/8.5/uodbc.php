...
use BrevoScoped\Safe\Exceptions\UodbcException;
/**
 ...
 *
 */
function odbc_autocommit(\BrevoScoped\Odbc\Connection $odbc, ?bool $enable = null)
{
    error_clear_last();
    if ($enable !== null) {
 ...
 *
 */
function odbc_columnprivileges(\BrevoScoped\Odbc\Connection $odbc, string $catalog, string $schema, string $table, string $column)
{
    error_clear_last();
 ...
 *
 */
function odbc_columns(\BrevoScoped\Odbc\Connection $odbc, ?string $catalog = null, ?string $schema = null, ?string $table = null, ?string $column = null)
{
    error_clear_last();
    if ($column !== null) {
 ...
 *
 */
function odbc_commit(\BrevoScoped\Odbc\Connection $odbc): void
{
    error_clear_last();
 ...
 *
 */
function odbc_connect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER): \BrevoScoped\Odbc\Connection
{
    error_clear_last();
 ...
 *
 */
function odbc_cursor(\BrevoScoped\Odbc\Result $statement): string
{
    error_clear_last();
 ...
 *
 */
function odbc_data_source(\BrevoScoped\Odbc\Connection $odbc, int $fetch_type): array
{
    error_clear_last();
 ...
 *
 */
function odbc_exec(\BrevoScoped\Odbc\Connection $odbc, string $query): \BrevoScoped\Odbc\Result
{
    error_clear_last();
 ...
 *
 */
function odbc_execute(\BrevoScoped\Odbc\Result $statement, array $params = []): void
{
    error_clear_last();
 ...
 *
 */
function odbc_fetch_into(\BrevoScoped\Odbc\Result $statement, ?array &$array, ?int $row = null): int
{
    error_clear_last();
    if ($row !== null) {
 ...
 *
 */
function odbc_field_len(\BrevoScoped\Odbc\Result $statement, int $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_name(\BrevoScoped\Odbc\Result $statement, int $field): string
{
    error_clear_last();
 ...
 *
 */
function odbc_field_num(\BrevoScoped\Odbc\Result $statement, string $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_scale(\BrevoScoped\Odbc\Result $statement, int $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_type(\BrevoScoped\Odbc\Result $statement, int $field): string
{
    error_clear_last();
 ...
 *
 */
function odbc_foreignkeys(\BrevoScoped\Odbc\Connection $odbc, string $pk_catalog, string $pk_schema, string $pk_table, string $fk_catalog, string $fk_schema, string $fk_table)
{
    error_clear_last();
 ...
 *
 */
function odbc_gettypeinfo(\BrevoScoped\Odbc\Connection $odbc, int $data_type = 0)
{
    error_clear_last();
 ...
 *
 */
function odbc_longreadlen(\BrevoScoped\Odbc\Result $statement, int $length): bool
{
    error_clear_last();
 ...
 *
 */
function odbc_num_fields(\BrevoScoped\Odbc\Result $statement): int
{
    error_clear_last();
 ...
 *
 */
function odbc_pconnect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER): \BrevoScoped\Odbc\Connection
{
    error_clear_last();
    if ($cursor_option !== \SQL_CUR_USE_DRIVER) {
 ...
 *
 */
function odbc_prepare(\BrevoScoped\Odbc\Connection $odbc, string $query): \BrevoScoped\Odbc\Result
{
    error_clear_last();
 ...
 *
 */
function odbc_primarykeys(\BrevoScoped\Odbc\Connection $odbc, string $catalog, string $schema, string $table)
{
    error_clear_last();
 ...
 *
 */
function odbc_procedures($odbc, ?string $catalog = null, ?string $schema = null, ?string $procedure = null): \BrevoScoped\Odbc\Result
{
    error_clear_last();
    if ($procedure !== null) {
 ...
 *
 */
function odbc_result_all(\BrevoScoped\Odbc\Result $statement, string $format = ""): int
{
    error_clear_last();
 ...
 *
 */
function odbc_result(\BrevoScoped\Odbc\Result $statement, $field)
{
    error_clear_last();
 ...
 *
 */
function odbc_rollback(\BrevoScoped\Odbc\Connection $odbc): void
{
    error_clear_last();
 ...
 *
 */
function odbc_specialcolumns(\BrevoScoped\Odbc\Connection $odbc, int $type, string $catalog, string $schema, string $table, int $scope, int $nullable)
{
    error_clear_last();
 ...
 *
 */
function odbc_statistics(\BrevoScoped\Odbc\Connection $odbc, string $catalog, string $schema, string $table, int $unique, int $accuracy)
{
    error_clear_last();
 ...
 *
 */
function odbc_tableprivileges(\BrevoScoped\Odbc\Connection $odbc, string $catalog, string $schema, string $table)
{
    error_clear_last();
 ...
 *
 */
function odbc_tables(\BrevoScoped\Odbc\Connection $odbc, ?string $catalog = null, ?string $schema = null, ?string $table = null, ?string $types = null): \BrevoScoped\Odbc\Result
{
    error_clear_last();
    if ($types !== null) {
