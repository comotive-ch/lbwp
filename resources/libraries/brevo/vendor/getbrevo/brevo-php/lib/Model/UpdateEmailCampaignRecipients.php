...
class UpdateEmailCampaignRecipients implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['exclusionListIds' => 'int[]', 'listIds' => 'int[]', 'segmentIds' => 'int[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['exclusionListIds' => 'int64', 'listIds' => 'int64', 'segmentIds' => 'int64'];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['exclusionListIds' => 'exclusionListIds', 'listIds' => 'listIds', 'segmentIds' => 'segmentIds'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['exclusionListIds' => 'setExclusionListIds', 'listIds' => 'setListIds', 'segmentIds' => 'setSegmentIds'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['exclusionListIds' => 'getExclusionListIds', 'listIds' => 'getListIds', 'segmentIds' => 'getSegmentIds'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
