...
class RequestContactExport implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['exportAttributes' => 'string[]', 'customContactFilter' => 'BrevoScoped\Brevo\Client\Model\RequestContactExportCustomContactFilter', 'notifyUrl' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['exportAttributes' => null, 'customContactFilter' => null, 'notifyUrl' => 'url'];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['exportAttributes' => 'exportAttributes', 'customContactFilter' => 'customContactFilter', 'notifyUrl' => 'notifyUrl'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['exportAttributes' => 'setExportAttributes', 'customContactFilter' => 'setCustomContactFilter', 'notifyUrl' => 'setNotifyUrl'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['exportAttributes' => 'getExportAttributes', 'customContactFilter' => 'getCustomContactFilter', 'notifyUrl' => 'getNotifyUrl'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
