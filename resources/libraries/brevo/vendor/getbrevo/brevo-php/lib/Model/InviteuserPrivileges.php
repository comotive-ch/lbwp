...
class InviteuserPrivileges implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['feature' => 'string', 'permissions' => 'string[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['feature' => null, 'permissions' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['feature' => 'feature', 'permissions' => 'permissions'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['feature' => 'setFeature', 'permissions' => 'setPermissions'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['feature' => 'getFeature', 'permissions' => 'getPermissions'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    {
        return [self::FEATURE_EMAIL_CAMPAIGNS, self::FEATURE_SMS_CAMPAIGNS, self::FEATURE_CONTACTS, self::FEATURE_TEMPLATES, self::FEATURE_WORKFLOWS, self::FEATURE_FACEBOOK_ADS, self::FEATURE_LANDING_PAGES, self::FEATURE_TRANSACTIONAL_EMAILS, self::FEATURE_SMTP_API, self::FEATURE_USER_MANAGEMENT, self::FEATURE_SALES_PLATFORM, self::FEATURE_PHONE, self::FEATURE_CONVERSATIONS, self::FEATURE_SENDERS_DOMAINS_DEDICATED_IPS, self::FEATURE_PUSH_NOTIFICATIONS];
    }
    /**
     * Gets allowable values of the enum
     *
