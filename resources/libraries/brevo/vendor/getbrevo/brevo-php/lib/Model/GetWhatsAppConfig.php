...
class GetWhatsAppConfig implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['whatsappBusinessAccountId' => 'string', 'sendingLimit' => 'string', 'phoneNumberQuality' => 'string', 'whatsappBusinessAccountStatus' => 'string', 'businessStatus' => 'string', 'phoneNumberNameStatus' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['whatsappBusinessAccountId' => null, 'sendingLimit' => null, 'phoneNumberQuality' => null, 'whatsappBusinessAccountStatus' => null, 'businessStatus' => null, 'phoneNumberNameStatus' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['whatsappBusinessAccountId' => 'whatsappBusinessAccountId', 'sendingLimit' => 'sendingLimit', 'phoneNumberQuality' => 'phoneNumberQuality', 'whatsappBusinessAccountStatus' => 'whatsappBusinessAccountStatus', 'businessStatus' => 'businessStatus', 'phoneNumberNameStatus' => 'phoneNumberNameStatus'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['whatsappBusinessAccountId' => 'setWhatsappBusinessAccountId', 'sendingLimit' => 'setSendingLimit', 'phoneNumberQuality' => 'setPhoneNumberQuality', 'whatsappBusinessAccountStatus' => 'setWhatsappBusinessAccountStatus', 'businessStatus' => 'setBusinessStatus', 'phoneNumberNameStatus' => 'setPhoneNumberNameStatus'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['whatsappBusinessAccountId' => 'getWhatsappBusinessAccountId', 'sendingLimit' => 'getSendingLimit', 'phoneNumberQuality' => 'getPhoneNumberQuality', 'whatsappBusinessAccountStatus' => 'getWhatsappBusinessAccountStatus', 'businessStatus' => 'getBusinessStatus', 'phoneNumberNameStatus' => 'getPhoneNumberNameStatus'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    {
        return [self::PHONE_NUMBER_QUALITY_GREEN, self::PHONE_NUMBER_QUALITY_YELLOW, self::PHONE_NUMBER_QUALITY_RED];
    }
    /**
     * Gets allowable values of the enum
     *
