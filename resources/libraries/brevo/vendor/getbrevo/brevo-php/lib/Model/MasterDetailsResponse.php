...
class MasterDetailsResponse implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['email' => 'string', 'companyName' => 'string', 'id' => 'int', 'currencyCode' => 'string', 'timezone' => 'string', 'billingInfo' => 'BrevoScoped\Brevo\Client\Model\MasterDetailsResponseBillingInfo', 'planInfo' => 'BrevoScoped\Brevo\Client\Model\MasterDetailsResponsePlanInfo'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['email' => null, 'companyName' => null, 'id' => 'int64', 'currencyCode' => null, 'timezone' => null, 'billingInfo' => null, 'planInfo' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['email' => 'email', 'companyName' => 'companyName', 'id' => 'id', 'currencyCode' => 'currencyCode', 'timezone' => 'timezone', 'billingInfo' => 'billingInfo', 'planInfo' => 'planInfo'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['email' => 'setEmail', 'companyName' => 'setCompanyName', 'id' => 'setId', 'currencyCode' => 'setCurrencyCode', 'timezone' => 'setTimezone', 'billingInfo' => 'setBillingInfo', 'planInfo' => 'setPlanInfo'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['email' => 'getEmail', 'companyName' => 'getCompanyName', 'id' => 'getId', 'currencyCode' => 'getCurrencyCode', 'timezone' => 'getTimezone', 'billingInfo' => 'getBillingInfo', 'planInfo' => 'getPlanInfo'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
