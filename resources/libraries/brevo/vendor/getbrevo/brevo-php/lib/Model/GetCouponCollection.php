...
class GetCouponCollection implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'string', 'name' => 'string', 'defaultCoupon' => 'string', 'createdAt' => '\DateTime', 'totalCoupons' => 'int', 'remainingCoupons' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['id' => 'uuidv4', 'name' => 'uuidv4', 'defaultCoupon' => null, 'createdAt' => 'date-time', 'totalCoupons' => 'int64', 'remainingCoupons' => 'int64'];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'name' => 'name', 'defaultCoupon' => 'defaultCoupon', 'createdAt' => 'createdAt', 'totalCoupons' => 'totalCoupons', 'remainingCoupons' => 'remainingCoupons'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'name' => 'setName', 'defaultCoupon' => 'setDefaultCoupon', 'createdAt' => 'setCreatedAt', 'totalCoupons' => 'setTotalCoupons', 'remainingCoupons' => 'setRemainingCoupons'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'name' => 'getName', 'defaultCoupon' => 'getDefaultCoupon', 'createdAt' => 'getCreatedAt', 'totalCoupons' => 'getTotalCoupons', 'remainingCoupons' => 'getRemainingCoupons'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
