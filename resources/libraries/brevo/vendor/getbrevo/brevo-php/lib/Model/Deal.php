...
class Deal implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'string', 'attributes' => 'object', 'linkedContactsIds' => 'int[]', 'linkedCompaniesIds' => 'string[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['id' => null, 'attributes' => null, 'linkedContactsIds' => null, 'linkedCompaniesIds' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'attributes' => 'attributes', 'linkedContactsIds' => 'linkedContactsIds', 'linkedCompaniesIds' => 'linkedCompaniesIds'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'attributes' => 'setAttributes', 'linkedContactsIds' => 'setLinkedContactsIds', 'linkedCompaniesIds' => 'setLinkedCompaniesIds'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'attributes' => 'getAttributes', 'linkedContactsIds' => 'getLinkedContactsIds', 'linkedCompaniesIds' => 'getLinkedCompaniesIds'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
