...
class InviteAdminUserPrivileges implements ModelInterface, ArrayAccess
{
    ...
    {
        return [self::FEATURE_MY_PLAN, self::FEATURE_API, self::FEATURE_USER_MANAGEMENT, self::FEATURE_APP_MANAGEMENT];
    }
    /**
     * Gets allowable values of the enum
     *
    ...
    {
        return [self::PERMISSIONS_ALL, self::PERMISSIONS_NONE];
    }
    /**
