...
class GetWebhook implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['url' => 'string', 'id' => 'int', 'description' => 'string', 'events' => 'string[]', 'type' => 'string', 'createdAt' => 'string', 'modifiedAt' => 'string', 'batched' => 'bool', 'auth' => 'BrevoScoped\Brevo\Client\Model\GetWebhookAuth', 'headers' => '\Brevo\Client\Model\GetWebhookHeaders[]'];
    /**
    ...
    {
        return [self::TYPE_MARKETING, self::TYPE_TRANSACTIONAL];
    }
    /**
