...
class AbTestCampaignResult implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['winningVersion' => 'string', 'winningCriteria' => 'string', 'winningSubjectLine' => 'string', 'openRate' => 'string', 'clickRate' => 'string', 'winningVersionRate' => 'string', 'statistics' => 'BrevoScoped\Brevo\Client\Model\AbTestCampaignResultStatistics', 'clickedLinks' => 'BrevoScoped\Brevo\Client\Model\AbTestCampaignResultClickedLinks'];
    /**
