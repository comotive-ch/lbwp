...
class SendSmtpEmail implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['sender' => 'BrevoScoped\Brevo\Client\Model\SendSmtpEmailSender', 'to' => '\Brevo\Client\Model\SendSmtpEmailTo[]', 'bcc' => '\Brevo\Client\Model\SendSmtpEmailBcc[]', 'cc' => '\Brevo\Client\Model\SendSmtpEmailCc[]', 'htmlContent' => 'string', 'textContent' => 'string', 'subject' => 'string', 'replyTo' => 'BrevoScoped\Brevo\Client\Model\SendSmtpEmailReplyTo', 'attachment' => '\Brevo\Client\Model\SendSmtpEmailAttachment[]', 'headers' => 'object', 'templateId' => 'int', 'params' => 'object', 'messageVersions' => '\Brevo\Client\Model\SendSmtpEmailMessageVersions[]', 'tags' => 'string[]', 'scheduledAt' => '\DateTime', 'batchId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['sender' => null, 'to' => null, 'bcc' => null, 'cc' => null, 'htmlContent' => null, 'textContent' => null, 'subject' => null, 'replyTo' => null, 'attachment' => null, 'headers' => null, 'templateId' => 'int64', 'params' => null, 'messageVersions' => null, 'tags' => null, 'scheduledAt' => 'date-time', 'batchId' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['sender' => 'sender', 'to' => 'to', 'bcc' => 'bcc', 'cc' => 'cc', 'htmlContent' => 'htmlContent', 'textContent' => 'textContent', 'subject' => 'subject', 'replyTo' => 'replyTo', 'attachment' => 'attachment', 'headers' => 'headers', 'templateId' => 'templateId', 'params' => 'params', 'messageVersions' => 'messageVersions', 'tags' => 'tags', 'scheduledAt' => 'scheduledAt', 'batchId' => 'batchId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['sender' => 'setSender', 'to' => 'setTo', 'bcc' => 'setBcc', 'cc' => 'setCc', 'htmlContent' => 'setHtmlContent', 'textContent' => 'setTextContent', 'subject' => 'setSubject', 'replyTo' => 'setReplyTo', 'attachment' => 'setAttachment', 'headers' => 'setHeaders', 'templateId' => 'setTemplateId', 'params' => 'setParams', 'messageVersions' => 'setMessageVersions', 'tags' => 'setTags', 'scheduledAt' => 'setScheduledAt', 'batchId' => 'setBatchId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['sender' => 'getSender', 'to' => 'getTo', 'bcc' => 'getBcc', 'cc' => 'getCc', 'htmlContent' => 'getHtmlContent', 'textContent' => 'getTextContent', 'subject' => 'getSubject', 'replyTo' => 'getReplyTo', 'attachment' => 'getAttachment', 'headers' => 'getHeaders', 'templateId' => 'getTemplateId', 'params' => 'getParams', 'messageVersions' => 'getMessageVersions', 'tags' => 'getTags', 'scheduledAt' => 'getScheduledAt', 'batchId' => 'getBatchId'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
