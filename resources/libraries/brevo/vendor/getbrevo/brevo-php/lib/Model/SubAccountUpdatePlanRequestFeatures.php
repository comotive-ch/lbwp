...
class SubAccountUpdatePlanRequestFeatures implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['users' => 'int', 'landingPage' => 'int', 'inbox' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['users' => 'int64', 'landingPage' => 'int64', 'inbox' => 'int64'];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['users' => 'users', 'landingPage' => 'landingPage', 'inbox' => 'inbox'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['users' => 'setUsers', 'landingPage' => 'setLandingPage', 'inbox' => 'setInbox'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['users' => 'getUsers', 'landingPage' => 'getLandingPage', 'inbox' => 'getInbox'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
