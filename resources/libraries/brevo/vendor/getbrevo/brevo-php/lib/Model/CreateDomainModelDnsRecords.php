...
class CreateDomainModelDnsRecords implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['dkimRecord' => 'BrevoScoped\Brevo\Client\Model\CreateDomainModelDnsRecordsDkimRecord', 'brevoCode' => 'BrevoScoped\Brevo\Client\Model\CreateDomainModelDnsRecordsDkimRecord'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['dkimRecord' => null, 'brevoCode' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['dkimRecord' => 'dkim_record', 'brevoCode' => 'brevo_code'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['dkimRecord' => 'setDkimRecord', 'brevoCode' => 'setBrevoCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['dkimRecord' => 'getDkimRecord', 'brevoCode' => 'getBrevoCode'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
