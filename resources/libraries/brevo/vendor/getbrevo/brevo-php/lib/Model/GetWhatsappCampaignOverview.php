 ...
 */
namespace BrevoScoped\Brevo\Client\Model;
...
class GetWhatsappCampaignOverview implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'int', 'campaignName' => 'string', 'campaignStatus' => 'string', 'scheduledAt' => 'string', 'senderNumber' => 'string', 'stats' => 'BrevoScoped\Brevo\Client\Model\WhatsappCampStats', 'template' => 'BrevoScoped\Brevo\Client\Model\WhatsappCampTemplate', 'createdAt' => 'string', 'modifiedAt' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['id' => 'int64', 'campaignName' => null, 'campaignStatus' => null, 'scheduledAt' => null, 'senderNumber' => null, 'stats' => null, 'template' => null, 'createdAt' => null, 'modifiedAt' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'campaignName' => 'campaignName', 'campaignStatus' => 'campaignStatus', 'scheduledAt' => 'scheduledAt', 'senderNumber' => 'senderNumber', 'stats' => 'stats', 'template' => 'template', 'createdAt' => 'createdAt', 'modifiedAt' => 'modifiedAt'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'campaignName' => 'setCampaignName', 'campaignStatus' => 'setCampaignStatus', 'scheduledAt' => 'setScheduledAt', 'senderNumber' => 'setSenderNumber', 'stats' => 'setStats', 'template' => 'setTemplate', 'createdAt' => 'setCreatedAt', 'modifiedAt' => 'setModifiedAt'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'campaignName' => 'getCampaignName', 'campaignStatus' => 'getCampaignStatus', 'scheduledAt' => 'getScheduledAt', 'senderNumber' => 'getSenderNumber', 'stats' => 'getStats', 'template' => 'getTemplate', 'createdAt' => 'getCreatedAt', 'modifiedAt' => 'getModifiedAt'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    {
        return [self::CAMPAIGN_STATUS_DRAFT, self::CAMPAIGN_STATUS_SCHEDULED, self::CAMPAIGN_STATUS_PENDING, self::CAMPAIGN_STATUS_APPROVED, self::CAMPAIGN_STATUS_RUNNING, self::CAMPAIGN_STATUS_SUSPENDED, self::CAMPAIGN_STATUS_REJECTED, self::CAMPAIGN_STATUS_SENT];
    }
    /**
    ...
    {
        $allowedValues = $this->getCampaignStatusAllowableValues();
        if (!in_array($campaignStatus, $allowedValues, \true)) {
