...
class CreateWhatsAppCampaignRecipients implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['excludedListIds' => 'int[]', 'listIds' => 'int[]', 'segments' => 'int[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['excludedListIds' => 'int64', 'listIds' => 'int64', 'segments' => 'int64'];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['excludedListIds' => 'excludedListIds', 'listIds' => 'listIds', 'segments' => 'segments'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['excludedListIds' => 'setExcludedListIds', 'listIds' => 'setListIds', 'segments' => 'setSegments'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['excludedListIds' => 'getExcludedListIds', 'listIds' => 'getListIds', 'segments' => 'getSegments'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
