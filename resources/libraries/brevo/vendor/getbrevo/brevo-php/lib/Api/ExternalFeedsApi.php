...
class ExternalFeedsApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\InlineResponse2015';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\InlineResponse2015', $e->getResponseHeaders());
    ...
    {
        return $this->createExternalFeedAsyncWithHttpInfo($createExternalFeed)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function createExternalFeedRequest($createExternalFeed)
    {
        ...
        if ($createExternalFeed === null || is_array($createExternalFeed) && count($createExternalFeed) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $createExternalFeed when calling createExternalFeed');
        }
        $resourcePath = '/feeds';
        $formParams = [];
        $queryParams = [];
    ...
    {
        return $this->deleteExternalFeedAsyncWithHttpInfo($uuid)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function deleteExternalFeedRequest($uuid)
    {
        ...
        if ($uuid === null || is_array($uuid) && count($uuid) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $uuid when calling deleteExternalFeed');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetAllExternalFeeds';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetAllExternalFeeds', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getAllExternalFeedsAsyncWithHttpInfo($search, $startDate, $endDate, $sort, $authType, $limit, $offset)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetExternalFeedByUUID';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetExternalFeedByUUID', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getExternalFeedByUUIDAsyncWithHttpInfo($uuid)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function getExternalFeedByUUIDRequest($uuid)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || is_array($uuid) && count($uuid) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $uuid when calling getExternalFeedByUUID');
        }
        $resourcePath = '/feeds/{uuid}';
        $formParams = [];
        $queryParams = [];
    ...
    {
        return $this->updateExternalFeedAsyncWithHttpInfo($uuid, $updateExternalFeed)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function updateExternalFeedRequest($uuid, $updateExternalFeed)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || is_array($uuid) && count($uuid) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $uuid when calling updateExternalFeed');
        }
        ...
        if ($updateExternalFeed === null || is_array($updateExternalFeed) && count($updateExternalFeed) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $updateExternalFeed when calling updateExternalFeed');
        }
        $resourcePath = '/feeds/{uuid}';
        $formParams = [];
        $queryParams = [];
