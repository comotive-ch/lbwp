...
class ContactsApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\PostContactInfo';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\PostContactInfo', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\CreateUpdateContactModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\CreateUpdateContactModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\CreateModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\CreateModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->deleteContactAsyncWithHttpInfo($identifier, $identifierType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->deleteMultiAttributeOptionsAsyncWithHttpInfo($attributeType, $multipleChoiceAttribute, $multipleChoiceAttributeOption)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function deleteMultiAttributeOptionsRequest($attributeType, $multipleChoiceAttribute, $multipleChoiceAttributeOption)
    {
        ...
        if ($attributeType === null || is_array($attributeType) && count($attributeType) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $attributeType when calling deleteMultiAttributeOptions');
        }
        ...
        if ($multipleChoiceAttribute === null || is_array($multipleChoiceAttribute) && count($multipleChoiceAttribute) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $multipleChoiceAttribute when calling deleteMultiAttributeOptions');
        }
        ...
        if ($multipleChoiceAttributeOption === null || is_array($multipleChoiceAttributeOption) && count($multipleChoiceAttributeOption) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $multipleChoiceAttributeOption when calling deleteMultiAttributeOptions');
        }
        ...
        if ($attributeType !== null) {
            $resourcePath = str_replace('{' . 'attributeType' . '}', ObjectSerializer::toPathValue($attributeType), $resourcePath);
        }
        // path params
        if ($multipleChoiceAttribute !== null) {
            $resourcePath = str_replace('{' . 'multipleChoiceAttribute' . '}', ObjectSerializer::toPathValue($multipleChoiceAttribute), $resourcePath);
        }
        // path params
        if ($multipleChoiceAttributeOption !== null) {
            $resourcePath = str_replace('{' . 'multipleChoiceAttributeOption' . '}', ObjectSerializer::toPathValue($multipleChoiceAttributeOption), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetAttributes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetAttributes', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetExtendedContactDetails';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetExtendedContactDetails', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getContactInfoAsyncWithHttpInfo($identifier, $identifierType, $startDate, $endDate)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetContactCampaignStats';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetContactCampaignStats', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetContacts';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetContacts', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getContactsAsyncWithHttpInfo($limit, $offset, $modifiedSince, $createdSince, $sort, $segmentId, $listIds, $filter)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetFolder';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetFolder', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetFolderLists';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetFolderLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetFolders';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetFolders', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetExtendedList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetExtendedList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getListAsyncWithHttpInfo($listId, $startDate, $endDate)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetLists';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetSegments';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetSegments', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getSegmentsAsyncWithHttpInfo($limit, $offset, $sort)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function getSegmentsRequest($limit, $offset, $sort = 'desc')
    {
        // verify the required parameter 'limit' is set
        if ($limit === null || is_array($limit) && count($limit) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $limit when calling getSegments');
        }
        if ($limit > 50) {
        ...
        // verify the required parameter 'offset' is set
        if ($offset === null || is_array($offset) && count($offset) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $offset when calling getSegments');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\CreatedProcessId';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\CreatedProcessId', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->updateBatchContactsAsyncWithHttpInfo($updateBatchContacts)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function updateBatchContactsRequest($updateBatchContacts)
    {
        ...
        if ($updateBatchContacts === null || is_array($updateBatchContacts) && count($updateBatchContacts) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $updateBatchContacts when calling updateBatchContacts');
        }
    ...
    {
        return $this->updateContactAsyncWithHttpInfo($identifier, $updateContact, $identifierType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
