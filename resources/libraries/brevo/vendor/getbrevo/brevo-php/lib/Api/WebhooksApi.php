...
class WebhooksApi
{
    ...
    {
        return $this->exportWebhooksHistoryAsyncWithHttpInfo($exportWebhookHistory)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function exportWebhooksHistoryRequest($exportWebhookHistory)
    {
        ...
        if ($exportWebhookHistory === null || is_array($exportWebhookHistory) && count($exportWebhookHistory) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $exportWebhookHistory when calling exportWebhooksHistory');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetWebhook';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetWebhook', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetWebhooks';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetWebhooks', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
