...
class CouponsApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\InlineResponse2013';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\InlineResponse2013', $e->getResponseHeaders());
    ...
    {
        return $this->createCouponCollectionAsyncWithHttpInfo($createCouponCollection)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->createCouponsAsyncWithHttpInfo($createCoupons)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetCouponCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetCouponCollection', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getCouponCollectionAsyncWithHttpInfo($id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->getCouponCollectionsAsyncWithHttpInfo($limit, $offset, $sort)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\InlineResponse2002';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\InlineResponse2002', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->updateCouponCollectionAsyncWithHttpInfo($id, $updateCouponCollection)->then(function ($response) {
            return $response[0];
        });
    }
    /**
