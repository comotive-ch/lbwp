...
class InboundParsingApi
{
    ...
    {
        return $this->getInboundEmailAttachmentAsyncWithHttpInfo($downloadToken)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function getInboundEmailAttachmentRequest($downloadToken)
    {
        ...
        if ($downloadToken === null || is_array($downloadToken) && count($downloadToken) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $downloadToken when calling getInboundEmailAttachment');
        }
        ...
        if ($downloadToken !== null) {
            $resourcePath = str_replace('{' . 'downloadToken' . '}', ObjectSerializer::toPathValue($downloadToken), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetInboundEmailEvents';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetInboundEmailEvents', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getInboundEmailEventsAsyncWithHttpInfo($sender, $startDate, $endDate, $limit, $offset, $sort)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetInboundEmailEventsByUuid';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetInboundEmailEventsByUuid', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getInboundEmailEventsByUuidAsyncWithHttpInfo($uuid)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function getInboundEmailEventsByUuidRequest($uuid)
    {
        ...
        if ($uuid === null || is_array($uuid) && count($uuid) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $uuid when calling getInboundEmailEventsByUuid');
        }
