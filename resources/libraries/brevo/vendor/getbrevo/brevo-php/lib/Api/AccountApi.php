...
class AccountApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetAccount';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetAccount', $e->getResponseHeaders());
