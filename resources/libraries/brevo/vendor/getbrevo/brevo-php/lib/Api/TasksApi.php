...
class TasksApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\InlineResponse2012';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\InlineResponse2012', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
