...
class FilesApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\FileList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\FileList', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\FileData';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\FileData', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\FileDownloadableLink';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\FileDownloadableLink', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    protected function crmFilesPostRequest($file, $dealId = null, $contactId = null, $companyId = null)
    {
        ...
        if ($file !== null) {
            $multipart = \true;
            $formParams['file'] = \BrevoScoped\GuzzleHttp\Psr7\try_fopen(ObjectSerializer::toFormValue($file), 'rb');
        }
        // form params
        if ($dealId !== null) {
