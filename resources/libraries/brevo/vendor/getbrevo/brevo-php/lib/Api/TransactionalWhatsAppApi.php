...
class TransactionalWhatsAppApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetWhatsappEventReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetWhatsappEventReport', $e->getResponseHeaders());
    ...
    {
        return $this->getWhatsappEventReportAsyncWithHttpInfo($limit, $offset, $startDate, $endDate, $days, $contactNumber, $event, $sort)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\InlineResponse2014';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\InlineResponse2014', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->sendWhatsappMessageAsyncWithHttpInfo($sendWhatsappMessage)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function sendWhatsappMessageRequest($sendWhatsappMessage)
    {
        ...
        if ($sendWhatsappMessage === null || is_array($sendWhatsappMessage) && count($sendWhatsappMessage) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $sendWhatsappMessage when calling sendWhatsappMessage');
        }
