 ...
 */
namespace BrevoScoped\Brevo\Client\Api;

use BrevoScoped\GuzzleHttp\Client;
use BrevoScoped\GuzzleHttp\ClientInterface;
use BrevoScoped\GuzzleHttp\Exception\RequestException;
use BrevoScoped\GuzzleHttp\Psr7\MultipartStream;
use BrevoScoped\GuzzleHttp\Psr7\Request;
use BrevoScoped\GuzzleHttp\RequestOptions;
use BrevoScoped\Brevo\Client\ApiException;
use BrevoScoped\Brevo\Client\Configuration;
use BrevoScoped\Brevo\Client\HeaderSelector;
use BrevoScoped\Brevo\Client\ObjectSerializer;
/**
...
class MasterAccountApi
{
    ...
    public function corporateGroupIdPutWithHttpInfo($id, $body)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->corporateGroupIdPutAsyncWithHttpInfo($id, $body)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateGroupIdPutRequest($id, $body)
    {
        ...
        if ($id === null || is_array($id) && count($id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling corporateGroupIdPut');
        }
        // verify the required parameter 'body' is set
        if ($body === null || is_array($body) && count($body) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling corporateGroupIdPut');
        }
        ...
        if (isset($_tempBody)) {
            ...
            if ($headers['Content-Type'] === 'application/json') {
                ...
                if ($httpBody instanceof \stdClass) {
                    $httpBody = \BrevoScoped\GuzzleHttp\json_encode($httpBody);
                }
                // array has no __toString(), so we should encode it manually
                if (is_array($httpBody)) {
                    $httpBody = \BrevoScoped\GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($httpBody));
                }
            }
            ...
            if ($multipart) {
                ...
                $httpBody = \BrevoScoped\GuzzleHttp\json_encode($formParams);
            } else {
                // for HTTP post (form)
                $httpBody = \BrevoScoped\GuzzleHttp\Psr7\Query::build($formParams);
            }
        }
        ...
        $query = \BrevoScoped\GuzzleHttp\Psr7\Query::build($queryParams);
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\InlineResponse201';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\InlineResponse201', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->corporateGroupPostAsyncWithHttpInfo($body)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateGroupPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || is_array($body) && count($body) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling corporateGroupPost');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\MasterDetailsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\MasterDetailsResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->corporateMasterAccountGetAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\SubAccountsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\SubAccountsResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->corporateSubAccountGetAsyncWithHttpInfo($offset, $limit)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateSubAccountGetRequest($offset, $limit)
    {
        ...
        if ($offset === null || is_array($offset) && count($offset) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $offset when calling corporateSubAccountGet');
        }
        // verify the required parameter 'limit' is set
        if ($limit === null || is_array($limit) && count($limit) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $limit when calling corporateSubAccountGet');
        }
    ...
    {
        return $this->corporateSubAccountIdApplicationsTogglePutAsyncWithHttpInfo($id, $toggleApplications)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateSubAccountIdApplicationsTogglePutRequest($id, $toggleApplications)
    {
        // verify the required parameter 'id' is set
        if ($id === null || is_array($id) && count($id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling corporateSubAccountIdApplicationsTogglePut');
        }
        ...
        if ($toggleApplications === null || is_array($toggleApplications) && count($toggleApplications) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $toggleApplications when calling corporateSubAccountIdApplicationsTogglePut');
        }
    ...
    {
        return $this->corporateSubAccountIdDeleteAsyncWithHttpInfo($id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateSubAccountIdDeleteRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || is_array($id) && count($id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling corporateSubAccountIdDelete');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\SubAccountDetailsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\SubAccountDetailsResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->corporateSubAccountIdGetAsyncWithHttpInfo($id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateSubAccountIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || is_array($id) && count($id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling corporateSubAccountIdGet');
        }
        $resourcePath = '/corporate/subAccount/{id}';
        $formParams = [];
        $queryParams = [];
    ...
    {
        return $this->corporateSubAccountIdPlanPutAsyncWithHttpInfo($id, $updatePlanDetails)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateSubAccountIdPlanPutRequest($id, $updatePlanDetails)
    {
        // verify the required parameter 'id' is set
        if ($id === null || is_array($id) && count($id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling corporateSubAccountIdPlanPut');
        }
        ...
        if ($updatePlanDetails === null || is_array($updatePlanDetails) && count($updatePlanDetails) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $updatePlanDetails when calling corporateSubAccountIdPlanPut');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\CreateApiKeyResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\CreateApiKeyResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->corporateSubAccountKeyPostAsyncWithHttpInfo($createApiKeyRequest)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateSubAccountKeyPostRequest($createApiKeyRequest)
    {
        ...
        if ($createApiKeyRequest === null || is_array($createApiKeyRequest) && count($createApiKeyRequest) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $createApiKeyRequest when calling corporateSubAccountKeyPost');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\CreateSubAccountResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\CreateSubAccountResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->corporateSubAccountPostAsyncWithHttpInfo($subAccountCreate)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateSubAccountPostRequest($subAccountCreate)
    {
        ...
        if ($subAccountCreate === null || is_array($subAccountCreate) && count($subAccountCreate) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $subAccountCreate when calling corporateSubAccountPost');
        }
        $resourcePath = '/corporate/subAccount';
        $formParams = [];
        $queryParams = [];
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetSsoToken';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetSsoToken', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->corporateSubAccountSsoTokenPostAsyncWithHttpInfo($ssoTokenRequest)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateSubAccountSsoTokenPostRequest($ssoTokenRequest)
    {
        ...
        if ($ssoTokenRequest === null || is_array($ssoTokenRequest) && count($ssoTokenRequest) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $ssoTokenRequest when calling corporateSubAccountSsoTokenPost');
        }
    ...
    {
        return $this->corporateUserRevokeEmailDeleteAsyncWithHttpInfo($email)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function corporateUserRevokeEmailDeleteRequest($email)
    {
        ...
        if ($email === null || is_array($email) && count($email) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $email when calling corporateUserRevokeEmailDelete');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetAccountActivity';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetAccountActivity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetCorporateInvitedUsersList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetCorporateInvitedUsersList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getCorporateInvitedUsersListAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getSubAccountGroupsWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Brevo\Client\Model\InlineResponse200[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getSubAccountGroupsAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\InviteAdminUser';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\InviteAdminUser', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->inviteAdminUserAsyncWithHttpInfo($sendInvitation)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function inviteAdminUserRequest($sendInvitation)
    {
        ...
        if ($sendInvitation === null || is_array($sendInvitation) && count($sendInvitation) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $sendInvitation when calling inviteAdminUser');
        }
