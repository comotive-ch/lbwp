...
class WhatsAppCampaignsApi
{
    ...
    {
        return $this->createWhatsAppCampaignAsyncWithHttpInfo($whatsAppCampaigns)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function createWhatsAppCampaignRequest($whatsAppCampaigns)
    {
        ...
        if ($whatsAppCampaigns === null || is_array($whatsAppCampaigns) && count($whatsAppCampaigns) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $whatsAppCampaigns when calling createWhatsAppCampaign');
        }
    ...
    {
        return $this->createWhatsAppTemplateAsyncWithHttpInfo($whatsAppTemplates)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->deleteWhatsAppCampaignAsyncWithHttpInfo($campaignId)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function deleteWhatsAppCampaignRequest($campaignId)
    {
        ...
        if ($campaignId === null || is_array($campaignId) && count($campaignId) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $campaignId when calling deleteWhatsAppCampaign');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetWhatsappCampaignOverview';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetWhatsappCampaignOverview', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getWhatsAppCampaignAsyncWithHttpInfo($campaignId)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function getWhatsAppCampaignRequest($campaignId)
    {
        // verify the required parameter 'campaignId' is set
        if ($campaignId === null || is_array($campaignId) && count($campaignId) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $campaignId when calling getWhatsAppCampaign');
        }
        $resourcePath = '/whatsappCampaigns/{campaignId}';
        $formParams = [];
        $queryParams = [];
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetWhatsappCampaigns';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetWhatsappCampaigns', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getWhatsAppCampaignsAsyncWithHttpInfo($startDate, $endDate, $limit, $offset, $sort)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetWhatsAppConfig';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetWhatsAppConfig', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getWhatsAppConfigAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetWATemplates';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetWATemplates', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->sendWhatsAppTemplateApprovalAsyncWithHttpInfo($templateId)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function sendWhatsAppTemplateApprovalRequest($templateId)
    {
        ...
        if ($templateId === null || is_array($templateId) && count($templateId) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $templateId when calling sendWhatsAppTemplateApproval');
        }
    ...
    {
        return $this->updateWhatsAppCampaignAsyncWithHttpInfo($campaignId, $whatsAppCampaign)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function updateWhatsAppCampaignRequest($campaignId, $whatsAppCampaign = null)
    {
        // verify the required parameter 'campaignId' is set
        if ($campaignId === null || is_array($campaignId) && count($campaignId) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $campaignId when calling updateWhatsAppCampaign');
        }
        $resourcePath = '/whatsappCampaigns/{campaignId}';
        $formParams = [];
        $queryParams = [];
