...
class TransactionalEmailsApi
{
    ...
    {
        return $this->deleteScheduledEmailByIdAsyncWithHttpInfo($identifier)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function deleteScheduledEmailByIdRequest($identifier)
    {
        ...
        if ($identifier === null || is_array($identifier) && count($identifier) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $identifier when calling deleteScheduledEmailById');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetAggregatedReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetAggregatedReport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetBlockedDomains';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetBlockedDomains', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetEmailEventReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetEmailEventReport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetScheduledEmailByBatchId';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetScheduledEmailByBatchId', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getScheduledEmailByBatchIdAsyncWithHttpInfo($batchId, $startDate, $endDate, $sort, $status, $limit, $offset)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function getScheduledEmailByBatchIdRequest($batchId, $startDate = null, $endDate = null, $sort = 'desc', $status = null, $limit = '100', $offset = '0')
    {
        ...
        if ($batchId === null || is_array($batchId) && count($batchId) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $batchId when calling getScheduledEmailByBatchId');
        }
        ...
        // path params
        if ($batchId !== null) {
            $resourcePath = str_replace('{' . 'batchId' . '}', ObjectSerializer::toPathValue($batchId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetScheduledEmailByMessageId';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetScheduledEmailByMessageId', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getScheduledEmailByMessageIdAsyncWithHttpInfo($messageId, $startDate, $endDate)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function getScheduledEmailByMessageIdRequest($messageId, $startDate = null, $endDate = null)
    {
        ...
        if ($messageId === null || is_array($messageId) && count($messageId) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $messageId when calling getScheduledEmailByMessageId');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetReports';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetReports', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetSmtpTemplateOverview';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetSmtpTemplateOverview', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetSmtpTemplates';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetSmtpTemplates', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetTransacBlockedContacts';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetTransacBlockedContacts', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetTransacEmailContent';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetTransacEmailContent', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetTransacEmailsList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetTransacEmailsList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    public function sendTestTemplateWithHttpInfo($templateId, $sendTestEmail)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\PostSendFailed', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\CreateSmtpEmail';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\CreateSmtpEmail', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 202:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ScheduleSmtpEmail', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->smtpLogIdentifierDeleteAsyncWithHttpInfo($identifier)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function smtpLogIdentifierDeleteRequest($identifier)
    {
        // verify the required parameter 'identifier' is set
        if ($identifier === null || is_array($identifier) && count($identifier) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $identifier when calling smtpLogIdentifierDelete');
        }
