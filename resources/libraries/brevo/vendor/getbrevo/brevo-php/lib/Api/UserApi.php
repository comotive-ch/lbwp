...
class UserApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\Inviteuser';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\Inviteuser', $e->getResponseHeaders());
    ...
    {
        return $this->editUserPermissionAsyncWithHttpInfo($updatePermissions)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetInvitedUsersList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetInvitedUsersList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getInvitedUsersListAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetUserPermission';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetUserPermission', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getUserPermissionAsyncWithHttpInfo($email)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->inviteuserAsyncWithHttpInfo($sendInvitation)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\PutRevokeUserPermission';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\PutRevokeUserPermission', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->putRevokeUserPermissionAsyncWithHttpInfo($email)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\Putresendcancelinvitation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\Putresendcancelinvitation', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->putresendcancelinvitationAsyncWithHttpInfo($action, $email)->then(function ($response) {
            return $response[0];
        });
    }
    /**
