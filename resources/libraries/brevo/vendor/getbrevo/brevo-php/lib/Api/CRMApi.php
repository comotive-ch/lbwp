...
class CRMApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\NoteList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\NoteList', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\Note';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\Note', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\NoteId';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\NoteId', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\TaskList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\TaskList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->crmTasksGetAsyncWithHttpInfo($filterType, $filterStatus, $filterDate, $filterAssignTo, $filterContacts, $filterDeals, $filterCompanies, $dateFrom, $dateTo, $offset, $limit, $sort, $sortBy)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->crmTasksIdDeleteAsyncWithHttpInfo($id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function crmTasksIdDeleteRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || is_array($id) && count($id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling crmTasksIdDelete');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\Task';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\Task', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->crmTasksIdGetAsyncWithHttpInfo($id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function crmTasksIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || is_array($id) && count($id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling crmTasksIdGet');
        }
        $resourcePath = '/crm/tasks/{id}';
        $formParams = [];
        $queryParams = [];
    ...
    {
        return $this->crmTasksIdPatchAsyncWithHttpInfo($id, $body)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function crmTasksIdPatchRequest($id, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null || is_array($id) && count($id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling crmTasksIdPatch');
        }
        // verify the required parameter 'body' is set
        if ($body === null || is_array($body) && count($body) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling crmTasksIdPatch');
        }
        $resourcePath = '/crm/tasks/{id}';
        $formParams = [];
        $queryParams = [];
    ...
    {
        return $this->crmTasksPostAsyncWithHttpInfo($body)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function crmTasksPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || is_array($body) && count($body) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling crmTasksPost');
        }
        $resourcePath = '/crm/tasks';
        $formParams = [];
        $queryParams = [];
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\TaskTypes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\TaskTypes', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->crmTasktypesGetAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
