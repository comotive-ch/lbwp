...
class DomainsApi
{
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\AuthenticateDomainModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\AuthenticateDomainModel', $e->getResponseHeaders());
    ...
    {
        return $this->authenticateDomainAsyncWithHttpInfo($domainName)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function authenticateDomainRequest($domainName)
    {
        ...
        if ($domainName === null || is_array($domainName) && count($domainName) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $domainName when calling authenticateDomain');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\CreateDomainModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\CreateDomainModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->createDomainAsyncWithHttpInfo($domainName)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->deleteDomainAsyncWithHttpInfo($domainName)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function deleteDomainRequest($domainName)
    {
        // verify the required parameter 'domainName' is set
        if ($domainName === null || is_array($domainName) && count($domainName) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $domainName when calling deleteDomain');
        }
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetDomainConfigurationModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetDomainConfigurationModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getDomainConfigurationAsyncWithHttpInfo($domainName)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function getDomainConfigurationRequest($domainName)
    {
        // verify the required parameter 'domainName' is set
        if ($domainName === null || is_array($domainName) && count($domainName) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $domainName when calling getDomainConfiguration');
        }
        $resourcePath = '/senders/domains/{domainName}';
        $formParams = [];
        $queryParams = [];
    ...
    {
        $returnType = 'BrevoScoped\Brevo\Client\Model\GetDomainsList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\GetDomainsList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'BrevoScoped\Brevo\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getDomainsAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
