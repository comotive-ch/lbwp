 ...
 * @link https://php.net/manual/en/class.pdoexception.php
 */
\class_alias('BrevoScoped\PDOException', 'PDOException', \false);
/**
...
class PDO
{
    ...
    public function query(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $query, #[LanguageLevelTypeAware(['8.0' => 'int|null'], default: '')] $fetchMode = null, #[LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] ...$fetchModeArgs)
    {
    }
    /**
     * (PHP 5 &gt;= 5.1.0, PHP 7, PECL pdo &gt;= 0.1.0)<br/>
 ...
 * @link https://php.net/manual/en/class.pdo.php
 */
\class_alias('BrevoScoped\PDO', 'PDO', \false);
/**
 ...
 * @link https://php.net/manual/en/class.pdostatement.php
 */
\class_alias('BrevoScoped\PDOStatement', 'PDOStatement', \false);
final class PDORow
{
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $queryString;
}
\class_alias('BrevoScoped\PDORow', 'PDORow', \false);
/**
 * (PHP 5 &gt;= 5.1.3, PHP 7, PECL pdo &gt;= 1.0.3)<br/>
 * Return an array of available PDO drivers
 * @link https://php.net/manual/en/pdo.getavailabledrivers.php
