...
\class_alias('BrevoScoped\UV', 'UV', \false);
abstract class UVStream extends \UV
{
}
\class_alias('BrevoScoped\UVStream', 'UVStream', \false);
class UVTcp extends \UVStream
{
}
\class_alias('BrevoScoped\UVTcp', 'UVTcp', \false);
class UVUdp extends \UV
{
}
\class_alias('BrevoScoped\UVUdp', 'UVUdp', \false);
class UVPipe extends \UVStream
{
}
\class_alias('BrevoScoped\UVPipe', 'UVPipe', \false);
class UVIdle extends \UV
{
}
\class_alias('BrevoScoped\UVIdle', 'UVIdle', \false);
class UVTimer extends \UV
{
}
\class_alias('BrevoScoped\UVTimer', 'UVTimer', \false);
class UVAsync extends \UV
{
}
\class_alias('BrevoScoped\UVAsync', 'UVAsync', \false);
class UVAddrinfo extends \UV
{
}
\class_alias('BrevoScoped\UVAddrinfo', 'UVAddrinfo', \false);
class UVProcess extends \UV
{
}
\class_alias('BrevoScoped\UVProcess', 'UVProcess', \false);
class UVPrepare extends \UV
{
}
\class_alias('BrevoScoped\UVPrepare', 'UVPrepare', \false);
class UVCheck extends \UV
{
}
\class_alias('BrevoScoped\UVCheck', 'UVCheck', \false);
class UVWork extends \UV
{
}
\class_alias('BrevoScoped\UVWork', 'UVWork', \false);
class UVFs extends \UV
{
}
\class_alias('BrevoScoped\UVFs', 'UVFs', \false);
class UVFsEvent extends \UV
{
}
\class_alias('BrevoScoped\UVFsEvent', 'UVFsEvent', \false);
class UVTty extends \UVStream
{
}
\class_alias('BrevoScoped\UVTty', 'UVTty', \false);
class UVFsPoll extends \UV
{
}
\class_alias('BrevoScoped\UVFsPoll', 'UVFsPoll', \false);
class UVPoll extends \UV
{
}
\class_alias('BrevoScoped\UVPoll', 'UVPoll', \false);
class UVSignal extends \UV
{
}
\class_alias('BrevoScoped\UVSignal', 'UVSignal', \false);
class UVLoop
{
}
\class_alias('BrevoScoped\UVLoop', 'UVLoop', \false);
abstract class UVSockAddr
{
}
\class_alias('BrevoScoped\UVSockAddr', 'UVSockAddr', \false);
class UVSockAddrIPv4 extends \UVSockAddr
{
}
\class_alias('BrevoScoped\UVSockAddrIPv4', 'UVSockAddrIPv4', \false);
class UVSockAddrIPv6 extends \UVSockAddr
{
}
\class_alias('BrevoScoped\UVSockAddrIPv6', 'UVSockAddrIPv6', \false);
class UVLock
{
}
\class_alias('BrevoScoped\UVLock', 'UVLock', \false);
class UVStdio
{
}
\class_alias('BrevoScoped\UVStdio', 'UVStdio', \false);
