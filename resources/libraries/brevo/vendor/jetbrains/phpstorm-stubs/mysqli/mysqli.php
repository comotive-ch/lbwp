 ...
 * mysqli_sql_exception
 */
\class_alias('BrevoScoped\mysqli_sql_exception', 'mysqli_sql_exception', \false);
/**
 * MySQLi Driver.
 ...
 * @link https://php.net/manual/en/class.mysqli-driver.php
 */
\class_alias('BrevoScoped\mysqli_driver', 'mysqli_driver', \false);
/**
...
class mysqli
{
     ...
     */
    #[TentativeType]
    public function change_user(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $username, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $password, #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $database): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function commit(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $name = null): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function query(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $query, #[PhpStormStubsElementAvailable(from: '7.1')] int $result_mode = \MYSQLI_STORE_RESULT): \mysqli_result|bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public static function poll(#[LanguageLevelTypeAware(['8.0' => 'array|null'], default: '')] &$read, #[LanguageLevelTypeAware(['8.0' => 'array|null'], default: '')] &$error, #[LanguageLevelTypeAware(['8.0' => 'array'], default: '')] &$reject, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $seconds, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $microseconds = 0): int|false
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function store_result(#[Deprecated(since: '8.4'), LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $mode = 0): \mysqli_result|false
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.mysqli.php
 */
\class_alias('BrevoScoped\mysqli', 'mysqli', \false);
/**
 ...
 * @link https://php.net/manual/en/class.mysqli-warning.php
 */
\class_alias('BrevoScoped\mysqli_warning', 'mysqli_warning', \false);
/**
 ...
 * @link https://php.net/manual/en/class.mysqli-result.php
 */
\class_alias('BrevoScoped\mysqli_result', 'mysqli_result', \false);
/**
...
class mysqli_stmt
{
     ...
     */
    #[TentativeType]
    public function attr_set(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $attribute, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $value): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function send_long_data(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $param_num, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $data): bool
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.mysqli-stmt.php
 */
\class_alias('BrevoScoped\mysqli_stmt', 'mysqli_stmt', \false);
/**
