 ...
 */
function dba_close(#[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): void
{
}
/**
 ...
 */
function dba_delete(#[LanguageLevelTypeAware(['8.2' => 'array|string'], default: '')] $key, #[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): bool
{
}
/**
 ...
 */
function dba_exists(#[LanguageLevelTypeAware(['8.2' => 'array|string'], default: '')] $key, #[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function dba_insert(#[LanguageLevelTypeAware(['8.2' => 'array|string'], default: '')] $key, string $value, #[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function dba_replace(#[LanguageLevelTypeAware(['8.2' => 'array|string'], default: '')] $key, string $value, #[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): bool
{
}
/**
 * Fetch first key
 ...
 */
function dba_firstkey(#[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): string|false
{
}
/**
 * Fetch next key
 ...
 * @return string|false the key on success or <b>FALSE</b> on failure.
 */
function dba_nextkey(#[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): string|false
{
}
/**
 * Optimize database
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function dba_optimize(#[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function dba_sync(#[LanguageLevelTypeAware(['8.4' => 'BrevoScoped\Dba\Connection'], default: 'resource')] $dba): bool
{
}
/**
