 ...
 */
\class_alias("Couchbase\\Cluster", "BrevoScoped\\CouchbaseCluster");
\class_alias("Couchbase\\Bucket", "BrevoScoped\\CouchbaseBucket");
\class_alias("Couchbase\\MutationToken", "BrevoScoped\\CouchbaseMutationToken");
\class_alias("Couchbase\\MutationState", "BrevoScoped\\CouchbaseMutationState");
\class_alias("Couchbase\\BucketManager", "BrevoScoped\\CouchbaseBucketManager");
\class_alias("BrevoScoped\\Couchbase\\ClusterManager", "BrevoScoped\\CouchbaseClusterManager");
\class_alias("BrevoScoped\\Couchbase\\LookupInBuilder", "BrevoScoped\\CouchbaseLookupInBuilder");
\class_alias("BrevoScoped\\Couchbase\\MutateInBuilder", "BrevoScoped\\CouchbaseMutateInBuilder");
\class_alias("BrevoScoped\\Couchbase\\N1qlQuery", "BrevoScoped\\CouchbaseN1qlQuery");
\class_alias("Couchbase\\SearchQuery", "BrevoScoped\\CouchbaseSearchQuery");
\class_alias("BrevoScoped\\Couchbase\\SearchQueryPart", "BrevoScoped\\CouchbaseAbstractSearchQuery");
\class_alias("Couchbase\\QueryStringSearchQuery", "BrevoScoped\\CouchbaseStringSearchQuery");
\class_alias("Couchbase\\MatchSearchQuery", "BrevoScoped\\CouchbaseMatchSearchQuery");
\class_alias("Couchbase\\MatchPhraseSearchQuery", "BrevoScoped\\CouchbaseMatchPhraseSearchQuery");
\class_alias("Couchbase\\PrefixSearchQuery", "BrevoScoped\\CouchbasePrefixSearchQuery");
\class_alias("Couchbase\\RegexpSearchQuery", "BrevoScoped\\CouchbaseRegexpSearchQuery");
\class_alias("Couchbase\\NumericRangeSearchQuery", "BrevoScoped\\CouchbaseNumericRangeSearchQuery");
\class_alias("Couchbase\\DisjunctionSearchQuery", "BrevoScoped\\CouchbaseDisjunctionSearchQuery");
\class_alias("Couchbase\\DateRangeSearchQuery", "BrevoScoped\\CouchbaseDateRangeSearchQuery");
\class_alias("Couchbase\\ConjunctionSearchQuery", "BrevoScoped\\CouchbaseConjunctionSearchQuery");
\class_alias("Couchbase\\BooleanSearchQuery", "BrevoScoped\\CouchbaseBooleanSearchQuery");
\class_alias("Couchbase\\WildcardSearchQuery", "BrevoScoped\\CouchbaseWildcardSearchQuery");
\class_alias("Couchbase\\DocIdSearchQuery", "BrevoScoped\\CouchbaseDocIdSearchQuery");
\class_alias("Couchbase\\BooleanFieldSearchQuery", "BrevoScoped\\CouchbaseBooleanFieldSearchQuery");
\class_alias("Couchbase\\TermSearchQuery", "BrevoScoped\\CouchbaseTermSearchQuery");
\class_alias("Couchbase\\PhraseSearchQuery", "BrevoScoped\\CouchbasePhraseSearchQuery");
\class_alias("Couchbase\\MatchAllSearchQuery", "BrevoScoped\\CouchbaseMatchAllSearchQuery");
\class_alias("Couchbase\\MatchNoneSearchQuery", "BrevoScoped\\CouchbaseMatchNoneSearchQuery");
\class_alias("Couchbase\\DateRangeSearchFacet", "BrevoScoped\\CouchbaseDateRangeSearchFacet");
\class_alias("Couchbase\\NumericRangeSearchFacet", "BrevoScoped\\CouchbaseNumericRangeSearchFacet");
\class_alias("Couchbase\\TermSearchFacet", "BrevoScoped\\CouchbaseTermSearchFacet");
\class_alias("Couchbase\\SearchFacet", "BrevoScoped\\CouchbaseSearchFacet");
\class_alias("BrevoScoped\\Couchbase\\ViewQuery", "BrevoScoped\\CouchbaseViewQuery");
\class_alias("BrevoScoped\\Couchbase\\DocumentFragment", "BrevoScoped\\CouchbaseDocumentFragment");
\class_alias("BrevoScoped\\Couchbase\\Document", "BrevoScoped\\CouchbaseMetaDoc");
\class_alias("BrevoScoped\\Couchbase\\Exception", "BrevoScoped\\CouchbaseException");
\class_alias("BrevoScoped\\Couchbase\\ClassicAuthenticator", "BrevoScoped\\CouchbaseAuthenticator");
