 ...
 * @template-implements Iterator<TKey, TYield>
 */
\class_alias('BrevoScoped\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('BrevoScoped\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace BrevoScoped\___PHPSTORM_HELPERS;
