...
use BrevoScoped\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware as LanguageAware;
use BrevoScoped\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as ElementAvailable;
...
\class_alias('BrevoScoped\Collator', 'Collator', \false);
...
\class_alias('BrevoScoped\NumberFormatter', 'NumberFormatter', \false);
class Normalizer
{
...
\class_alias('BrevoScoped\Normalizer', 'Normalizer', \false);
class Locale
{
    /**
...
\class_alias('BrevoScoped\Locale', 'Locale', \false);
...
\class_alias('BrevoScoped\MessageFormatter', 'MessageFormatter', \false);
...
\class_alias('BrevoScoped\IntlDateFormatter', 'IntlDateFormatter', \false);
class ResourceBundle implements \IteratorAggregate, \Countable
{
    ...
    public function get(#[LanguageAware(['8.4' => 'string|int'], default: '')] $index, #[LanguageAware(['8.0' => 'bool'], default: '')] $fallback = \true)
    {
    }
    /**
     * (PHP &gt;= 5.3.2, PECL intl &gt;= 2.0.0)<br/>
...
\class_alias('BrevoScoped\ResourceBundle', 'ResourceBundle', \false);
/**
 * @since 5.4
 */
 ...
 * @since 5.4
 */
\class_alias('BrevoScoped\Transliterator', 'Transliterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.spoofchecker.php
 */
\class_alias('BrevoScoped\Spoofchecker', 'Spoofchecker', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('BrevoScoped\IntlGregorianCalendar', 'IntlGregorianCalendar', \false);
/**
 * @since 5.5
 */
class IntlCalendar
 ...
 * @since 5.5
 */
\class_alias('BrevoScoped\IntlCalendar', 'IntlCalendar', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('BrevoScoped\IntlIterator', 'IntlIterator', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('BrevoScoped\IntlException', 'IntlException', \false);
/**
 * @since 5.5
 */
class IntlTimeZone
 ...
 * @since 5.5
 */
\class_alias('BrevoScoped\IntlTimeZone', 'IntlTimeZone', \false);
/**
 * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
 * Create a collator
 * @link https://php.net/manual/en/collator.create.php
...
class IntlBreakIterator implements \IteratorAggregate
{
    ...
    #[Pure]
    #[TentativeType]
    public function getPartsIterator(#[LanguageAware(['8.0' => 'int', '8.3' => 'string'], default: '')] #[EV([\IntlPartsIterator::KEY_SEQUENTIAL, \IntlPartsIterator::KEY_LEFT, \IntlPartsIterator::KEY_RIGHT])] $type = \IntlPartsIterator::KEY_SEQUENTIAL): \IntlPartsIterator
    {
    }
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
 ...
 * @since 5.5
 */
\class_alias('BrevoScoped\IntlBreakIterator', 'IntlBreakIterator', \false);
...
\class_alias('BrevoScoped\IntlRuleBasedBreakIterator', 'IntlRuleBasedBreakIterator', \false);
/**
 ...
 * @since 5.5
 */
\class_alias('BrevoScoped\IntlPartsIterator', 'IntlPartsIterator', \false);
...
\class_alias('BrevoScoped\IntlCodePointBreakIterator', 'IntlCodePointBreakIterator', \false);
class UConverter
{
    /* Constants */
     ...
     */
    #[TentativeType]
    public static function transcode(#[LanguageAware(['8.0' => 'string'], default: '')] $str, #[LanguageAware(['8.0' => 'string'], default: '')] $toEncoding, #[LanguageAware(['8.0' => 'string'], default: '')] $fromEncoding, #[LanguageAware(['8.0' => 'array|null'], default: '')] $options = null): string|false
    {
    }
}
\class_alias('BrevoScoped\UConverter', 'UConverter', \false);
// End of intl v.1.1.0
