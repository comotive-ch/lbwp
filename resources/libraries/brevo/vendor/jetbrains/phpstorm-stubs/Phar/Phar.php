 ...
 * @link https://php.net/manual/en/class.pharexception.php
 */
\class_alias('BrevoScoped\PharException', 'PharException', \false);
/**
...
class Phar extends \RecursiveDirectoryIterator implements \RecursiveIterator, \SeekableIterator, \Countable, \ArrayAccess
{
    ...
    #[TentativeType]
    #[LanguageLevelTypeAware(['8.4' => 'true'], default: 'bool')]
    public function setDefaultStub(#[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $index = null, #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $webIndex = null)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 1.0.0)<br/>
 ...
 * @link https://php.net/manual/en/class.phar.php
 */
\class_alias('BrevoScoped\Phar', 'Phar', \false);
/**
 ...
 * @link https://php.net/manual/en/class.phardata.php
 */
\class_alias('BrevoScoped\PharData', 'PharData', \false);
/**
 ...
 * @link https://php.net/manual/en/class.pharfileinfo.php
 */
\class_alias('BrevoScoped\PharFileInfo', 'PharFileInfo', \false);
// End of Phar v.2.0.1
