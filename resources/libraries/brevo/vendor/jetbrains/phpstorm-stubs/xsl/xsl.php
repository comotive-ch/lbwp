...
class XSLTProcessor
{
     ...
     */
    #[TentativeType]
    public function transformToDoc(#[LanguageLevelTypeAware(['8.0' => 'object'], default: '')] $document, #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $returnClass = null): object|false
    {
    }
    /**
     * Transform to URI
     ...
     */
    #[TentativeType]
    public function transformToUri(#[LanguageLevelTypeAware(['8.0' => 'object'], default: '')] $document, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $uri): int
    {
    }
    /**
     * Transform to XML
     ...
     */
    #[TentativeType]
    public function setParameter(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $namespace, #[LanguageLevelTypeAware(['8.0' => 'array|string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $value = null): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function getParameter(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $namespace, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name): string|false
    {
    }
    /**
     * Remove parameter
     ...
     */
    #[TentativeType]
    public function removeParameter(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $namespace, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name): bool
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.xsltprocessor.php
 */
\class_alias('BrevoScoped\XSLTProcessor', 'XSLTProcessor', \false);
