 ...
 * @see https://php.net/manual/en/class.event.php
 */
\class_alias('BrevoScoped\Event', 'Event', \false);
//  The EventBase class
/**
 * EventBase.
 ...
 * @see https://php.net/manual/en/class.eventbase.php
 */
\class_alias('BrevoScoped\EventBase', 'EventBase', \false);
 ...
 * @see https://php.net/manual/en/class.eventbuffer.php
 */
\class_alias('BrevoScoped\EventBuffer', 'EventBuffer', \false);
 ...
 * @see https://php.net/manual/en/class.eventbufferevent.php
 */
\class_alias('BrevoScoped\EventBufferEvent', 'EventBufferEvent', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventconfig.php
 */
\class_alias('BrevoScoped\EventConfig', 'EventConfig', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventdnsbase.php
 */
\class_alias('BrevoScoped\EventDnsBase', 'EventDnsBase', \false);
// The EventHttp class
/**
 * EventHttp.
 ...
 * @see https://secure.php.net/manual/en/class.eventhttp.php
 */
\class_alias('BrevoScoped\EventHttp', 'EventHttp', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventhttpconnection.php
 */
\class_alias('BrevoScoped\EventHttpConnection', 'EventHttpConnection', \false);
...
// The EventHttpRequest class
\class_alias('BrevoScoped\EventHttpRequest', 'EventHttpRequest', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventlistener.php
 */
\class_alias('BrevoScoped\EventListener', 'EventListener', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventsslcontext.php
 */
\class_alias('BrevoScoped\EventSslContext', 'EventSslContext', \false);
// The EventUtil class
/**
 * EventUtil.
 ...
 * @see https://secure.php.net/manual/en/class.eventutil.php
 */
\class_alias('BrevoScoped\EventUtil', 'EventUtil', \false);
