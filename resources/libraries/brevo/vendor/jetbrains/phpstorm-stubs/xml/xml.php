...
// Start of xml v.
use BrevoScoped\JetBrains\PhpStorm\Deprecated as Deprecated;
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_element_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $start_handler, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $end_handler)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_character_data_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $handler)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_processing_instruction_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $handler)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_default_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $handler)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_unparsed_entity_decl_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $handler)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_notation_decl_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $handler)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_external_entity_ref_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $handler)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_start_namespace_decl_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $handler)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(["8.2" => "true"], default: "bool")]
function xml_set_end_namespace_decl_handler(#[LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, #[LanguageLevelTypeAware(["8.4" => "callable|string|null"], default: "callable")] $handler)
{
}
/**
 ...
 * @since 8.0
 */
\class_alias('BrevoScoped\XMLParser', 'XMLParser', \false);
// End of xml v.
