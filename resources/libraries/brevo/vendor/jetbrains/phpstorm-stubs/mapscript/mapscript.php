 ...
 * created using:
 */
\class_alias('BrevoScoped\classObj', 'classObj', \false);
/**
 ...
 * Instance of clusterObj is always embedded inside the `layerObj`_.
 */
\class_alias('BrevoScoped\clusterObj', 'clusterObj', \false);
/**
 ...
 * Instances of colorObj are always embedded inside other classes.
 */
\class_alias('BrevoScoped\colorObj', 'colorObj', \false);
...
\class_alias('BrevoScoped\errorObj', 'errorObj', \false);
/**
 ...
 * $oLayer->grid->set("labelformat", "DDMMSS");
 */
\class_alias('BrevoScoped\gridObj', 'gridObj', \false);
/**
 ...
 * echo "Key: ".$key." value: ".$hashTable->get($key)."<br/>";
 */
\class_alias('BrevoScoped\hashTableObj', 'hashTableObj', \false);
/**
 ...
 * Instances of imageObj are always created by the `mapObj`_ class methods.
 */
\class_alias('BrevoScoped\imageObj', 'imageObj', \false);
...
\class_alias('BrevoScoped\labelcacheMemberObj', 'labelcacheMemberObj', \false);
...
\class_alias('BrevoScoped\labelcacheObj', 'labelcacheObj', \false);
/**
 ...
 * labelObj are always embedded inside other classes.
 */
\class_alias('BrevoScoped\labelObj', 'labelObj', \false);
/**
 ...
 * layer created.
 */
\class_alias('BrevoScoped\layerObj', 'layerObj', \false);
/**
 ...
 * Instances of legendObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('BrevoScoped\legendObj', 'legendObj', \false);
final class lineObj
{
    /**
     * read-only
...
\class_alias('BrevoScoped\lineObj', 'lineObj', \false);
final class mapObj
{
    /**
     * @var float
...
\class_alias('BrevoScoped\mapObj', 'mapObj', \false);
/**
 ...
 * No constructor available (coming soon, see ticket 979)
 */
\class_alias('BrevoScoped\outputformatObj', 'outputformatObj', \false);
...
\class_alias('BrevoScoped\OwsrequestObj', 'OwsrequestObj', \false);
...
\class_alias('BrevoScoped\pointObj', 'pointObj', \false);
...
\class_alias('BrevoScoped\projectionObj', 'projectionObj', \false);
/**
 ...
 * `mapObj`_.
 */
\class_alias('BrevoScoped\querymapObj', 'querymapObj', \false);
/**
 ...
 * also be created with:
 */
\class_alias('BrevoScoped\rectObj', 'rectObj', \false);
/**
 ...
 * Instances of referenceMapObj are always embedded inside the `mapObj`_.
 */
\class_alias('BrevoScoped\referenceMapObj', 'referenceMapObj', \false);
...
\class_alias('BrevoScoped\resultObj', 'resultObj', \false);
/**
 ...
 * Instances of scalebarObj are always embedded inside the `mapObj`_.
 */
\class_alias('BrevoScoped\scalebarObj', 'scalebarObj', \false);
...
\class_alias('BrevoScoped\shapefileObj', 'shapefileObj', \false);
...
\class_alias('BrevoScoped\shapeObj', 'shapeObj', \false);
/**
 ...
 * Instances of styleObj are always embedded inside a `classObj`_ or `labelObj`_.
 */
\class_alias('BrevoScoped\styleObj', 'styleObj', \false);
...
\class_alias('BrevoScoped\symbolObj', 'symbolObj', \false);
/**
 ...
 * Instances of webObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('BrevoScoped\webObj', 'webObj', \false);
