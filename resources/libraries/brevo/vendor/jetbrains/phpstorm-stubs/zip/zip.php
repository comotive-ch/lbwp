...
use BrevoScoped\JetBrains\PhpStorm\Internal\TentativeType;
/**
...
class ZipArchive implements \Countable
{
     ...
     */
    #[TentativeType]
    public function open(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $filename, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): int|bool
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.1.0)<br/>
     ...
     */
    #[TentativeType]
    public function addEmptyDir(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $dirname, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags): bool
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.1.0)<br/>
     ...
     */
    #[TentativeType]
    public function addFromString(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $content, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 8192): bool
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.1.0)<br/>
     ...
     */
    #[TentativeType]
    public function addFile(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $filepath, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $entryname = null, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $start = 0, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $length = 0, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 8192): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function addGlob(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $pattern, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, array $options = []): array|false
    {
    }
    /**
     * (PHP 5 &gt;= 5.3.0, PECL zip &gt;= 1.9.0)<br/>
     ...
     */
    #[TentativeType]
    public function addPattern(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $pattern, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $path = '.', array $options = []): array|false
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function renameIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $new_name): bool
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.5.0)<br/>
     ...
     */
    #[TentativeType]
    public function renameName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $new_name): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function setCommentIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $comment): bool
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.4.0)<br/>
     ...
     */
    #[TentativeType]
    public function setCommentName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $comment): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function getCommentIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): string|false
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.4.0)<br/>
     ...
     */
    #[TentativeType]
    public function getCommentName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): string|false
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.5.0)<br/>
     ...
     */
    #[TentativeType]
    public function statName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): array|false
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.1.0)<br/>
     ...
     */
    #[TentativeType]
    public function statIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): array|false
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.5.0)<br/>
     ...
     */
    #[TentativeType]
    public function locateName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): int|false
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.5.0)<br/>
     ...
     */
    #[TentativeType]
    public function getNameIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): string|false
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.1.0)<br/>
     ...
     */
    #[TentativeType]
    public function extractTo(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $pathto, #[LanguageLevelTypeAware(['8.0' => 'array|string|null'], default: '')] $files = null): bool
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.1.0)<br/>
     ...
     */
    #[TentativeType]
    public function getFromName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $len = 0, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): string|false
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function getFromIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $len = 0, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): string|false
    {
    }
    /**
     * (PHP 5 &gt;= 5.2.0, PECL zip &gt;= 1.1.0)<br/>
     ...
     * @return resource|false a file pointer (resource) on success or <b>FALSE</b> on failure.
     */
    public function getStreamIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0)
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function setExternalAttributesName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $opsys, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $attr, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function getExternalAttributesName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] &$opsys, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] &$attr, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function setExternalAttributesIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $opsys, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $attr, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): bool
    {
    }
    /**
     ...
     */
    #[TentativeType]
    public function getExternalAttributesIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] &$opsys, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] &$attr, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): bool
    {
    }
    ...
    #[TentativeType]
    public function registerProgressCallback(#[LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $rate, #[LanguageLevelTypeAware(['8.0' => 'callable'], default: '')] $callback): bool
    {
    }
    #[TentativeType]
    public function setMtimeName(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $timestamp, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): bool
    {
    }
    #[TentativeType]
    public function setMtimeIndex(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $timestamp, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): bool
    {
    }
    #[TentativeType]
    public function replaceFile(#[LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $filepath, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $index, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $start = null, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $length = null, #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = null): bool
    {
    }
     ...
     */
    #[LanguageLevelTypeAware(['8.0' => 'bool'], default: '')]
    public function setArchiveFlag(#[LanguageLevelTypeAware(['8.3' => 'int'], default: '')] $flag, #[LanguageLevelTypeAware(['8.3' => 'int'], default: '')] $value)
    {
    }
    /**
     * @param int $flag
    ...
    public function getArchiveFlag(#[LanguageLevelTypeAware(['8.3' => 'int'], default: '')] $flag, #[LanguageLevelTypeAware(['8.3' => 'int'], default: '')] $flags = 0)
    {
    }
    /**
     * @param string $name
     ...
     * @return void
     */
    public function getStreamName(#[LanguageLevelTypeAware(['8.2' => 'string'], default: '')] $name, #[LanguageLevelTypeAware(['8.2' => 'int'], default: '')] $flags = 0)
    {
    }
}
/**
 ...
 * @link https://php.net/manual/en/class.ziparchive.php
 */
\class_alias('BrevoScoped\ZipArchive', 'ZipArchive', \false);
/**
