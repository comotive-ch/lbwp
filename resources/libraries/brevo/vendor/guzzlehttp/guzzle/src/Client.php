...
use BrevoScoped\GuzzleHttp\Cookie\CookieJar;
use BrevoScoped\GuzzleHttp\Exception\GuzzleException;
use BrevoScoped\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \BrevoScoped\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
